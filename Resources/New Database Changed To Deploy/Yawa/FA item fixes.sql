...
begin
INSERT INTO Ac_FinancialAc(Name,PFinancialAcID,FinancialSysID,AddedBy,AddedOn,IsArchived,IsDebit,AccEntryType) 
VALUES('SALES DISCOUNT A/C',@RegularPurchaseId,@TransactionNodeId,'danfe',GETDATE(),0,1,@AccEntryTypeId);
end
else
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @RegularPurchaseId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='SALES DISCOUNT A/C'
end
