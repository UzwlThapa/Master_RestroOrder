...
/****** Object:  View [dbo].[vw_ROI_StockReportView]    Script Date: 1/22/2024 10:59:13 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dbo].[vw_ROI_StockReportView]
AS
...
/*
select * from RO_SalesMaster as RO_SalesMaster
select * from dbo.ROI_SalesStockTransaction

select * from ROI_SalesReturnStockTransaction

select * from ROI_StockTransactionMaster
select * from vw_ROI_StockReportView ORDER BY StockTranMasterId


select * from RO_PurchaseReturnDetails
*/