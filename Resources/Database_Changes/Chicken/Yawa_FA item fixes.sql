...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @DirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='BAR PURCHASE A/C'
END
...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @DirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='REGULAR PURCHASE A/C'
end
...
SELECT @inDirectExpensesId  = FinancialAcID from Ac_FinancialAc where Name = 'INDIRECT EXPENSES'
...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @inDirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='JAAR WATER'
end
...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @inDirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='pop up'
end
...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @inDirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='Office Expenses'
end
...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @inDirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='Fruit Shop'
end
...
begin
UPDATE Ac_FinancialAc SET FinancialSysID = @TransactionNodeId,PFinancialAcID = @inDirectExpensesId,IsDebit = 1,AccEntryType = @AccEntryTypeId WHERE name ='Staff Fooding'
end
