...
Done				: "Završio",
PasteWordConfirm	: "Tekst koji želite da nalepite kopiran je iz Worda. Da li želite da bude ocišcen od formata pre lepljenja?",
NotCompatiblePaste	: "Ova komanda je dostupna samo za Internet Explorer od verzije 5.5. Da li želite da nalepim tekst bez cišcenja?",
...
DlgFlashChkMenu		: "Ukljuci fleš meni",
...
PasteErrorCut	: "Sigurnosna podešavanja Vašeg pretraživaca ne dozvoljavaju operacije automatskog isecanja teksta. Molimo Vas da koristite precicu sa tastature (Ctrl+X).",
PasteErrorCopy	: "Sigurnosna podešavanja Vašeg pretraživaca ne dozvoljavaju operacije automatskog kopiranja teksta. Molimo Vas da koristite precicu sa tastature (Ctrl+C).",
...
DlgSpellOneChange		: "Provera spelovanja završena: Izmenjena je jedna rec",
DlgSpellManyChanges		: "Provera spelovanja završena: %1 rec(i) je izmenjeno",
