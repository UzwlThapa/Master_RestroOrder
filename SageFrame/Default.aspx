...
<body>
    ...
    <div id="shiftItems" style="display:none;">
        <table style="display:block;">
            <tr>
                ...
                <td class="shiftType" style="display:none;">Shift Type : <select id="selShiftType" class="sfInputbox" style="width:150px;">
                ...
                <td class="shiftTo">Table<select id="toTables" class="sfInputbox"></select> </td>
                <td class="shiftTo">Split No. <select id="toSplitNo" class="sfInputbox" style="width:100px;"></select></td>
            </tr>
        </table>
        ...
        <table id="tblOrderList" style="margin-left:10px;border-right:1px solid gainsboro;width:50%;">
            <thead>
                <tr>
                    ...
                    <td>Item Name</td>
                    <td>Quantity</td>
                    <td>Shift <img src="/Images/shift.png" id="shiftAllItems" class="preview-icon" type="button" /></td>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
        <table id="tblitemsList" style="width:50%;">
            <thead>
                <tr>
                    ...
                    <td>Item Name</td>
                    <td>Quantity</td>
                    <td>Deduct <img src="/Images/deduct.png" id="deductAllItems" class="preview-icon" type="button" /></td>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
    ...
    <div id="PINcode" style="display:none">
        ...
        <table id="pinpad">
            <tr>
                <td colspan="3"><input id='PINbox' class="sfInputbox" style='width:200px' type='password' value='' onkeypress='return IntegerAndDecimal(event,this);'  name='PINbox' /> 
                <span id="pinError" style="color:red;display:none;"> * Error Pincode</span> 
                </td> 
            </tr>
            <tr>
                <td><input type='button' class='PINbutton sfBtn' name='1' value='1'  /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='2' value='2' /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='3' value='3'  /></td> 
            </tr>
            <tr>
                <td><input type='button' class='PINbutton sfBtn' name='4' value='4' /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='5' value='5' /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='6' value='6' /></td> 
            </tr>
            <tr>
                <td><input type='button' class='PINbutton sfBtn' name='7' value='7'  /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='8' value='8'  /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='9' value='9'  /></td> 
            </tr>
            <tr>
                <td><input type='button' class='sfBtn clearpin' value='C' /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='0' value='0'  /></td> 
                <td><input type='button' class='sfBtn del' value='D' /></td>
            </tr>
        </table>
    </div>
        ...
        <table id="nummpad" runat="server">
              <tr>
                <td colspan="3"><input id='numbox' class="pincodetext" style='width:100%;' type='text' value='' onkeypress='return IntegerAndDecimal(event,this);' /></td> 
            </tr>
            <tr>
                <td><input type='button' class='PINbutton sfBtn' name='1' value='1' /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='2' value='2' /></td> 
            ...
            <tr>
                <td><input type='button' class='sfBtn Okaypin' value='Ok' /></td> 
                <td><input type='button' class='PINbutton sfBtn' name='0' value='0'  /></td> 
                <td><input type='button' class='sfBtn del' value='Del' /></td>
            </tr>
        </table>
    </div>  
