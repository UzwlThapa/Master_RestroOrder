    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (splitCostCenter) {
                ...
                htmls += ("<td colspan='4' style='text-align:right;border-bottom:1px dotted;font-size:" + billFontTotals + ";border-top:1px dotted;padding-right:8px;'><span style='font-weight:bold;font-size:" + billFontTotals + ";'>");
                if (totalItemsQntyVisible)
                    htmls += ("<span style='font-weight:bold;font-size:" + billFontTotals + ";'>Total Qty: " + itemsQnty + " </span></td><td colspan='2' style='text-align:right;border-bottom:1px dotted;font-size:" + billFontTotals + ";border-top:1px dotted;padding-right:8px;'>");
