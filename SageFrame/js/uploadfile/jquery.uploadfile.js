    ...
    $.fn.uploadFile = function (options) {
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
                ...
                pd.filename.html(fileNameStr);
                //var form = $("<div class='fileUpload'></div>");
                var form = $("<form style='display:block; position:absolute;left: 150px;' class='uploadFile " + obj.formGroup + "' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
                form.appendTo('body');
                var fileArray = [];
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var form = $("<div  class='uploadFile'></div>");
            //var form = $("<form method='" + s.method + "' class='uploadFile' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div data-type='" + s.fileType + "' class='ajax-file-upload-statusbar uploadDocsStatus'></div>").width(s.statusBarWidth);
            ...
            this.del = $("<div class='ajax-file-upload-red icon-delete'>" + s.deletelStr + "</div>").appendTo(this.statusbar).hide();
          //  $("<div class='ajax-file-upload-red docDelete icon-delete'></div>").appendTo(this.statusbar);
            if (s.showQueueDiv)
