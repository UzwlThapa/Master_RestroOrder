...
Done				: "Završio",
PasteWordConfirm	: "Tekst koji želite zalijepiti cini se da je kopiran iz Worda. Želite li prije ocistiti tekst?",
NotCompatiblePaste	: "Ova naredba je dostupna samo u Internet Exploreru 5.5 ili novijem. Želite li nastaviti bez cišcenja?",
...
NoActiveX			: "Vaše postavke pretraživaca mogle bi ograniciti neke od mogucnosti editora. Morate ukljuciti opciju \"Run ActiveX controls and plug-ins\" u postavkama. Ukoliko to ne ucinite, moguce su razliite greške tijekom rada.",
...
DlgBtnResetSize		: "Obriši velicinu",
DlgImgBorder		: "Okvir",
DlgImgHSpace		: "HSpace",
DlgImgVSpace		: "VSpace",
...
DlnLnkMsgInvPopName	: "Ime popup prozora mora poceti sa slovom i ne smije sadržavati razmake",
...
DlgFindNotFoundMsg	: "Traženi tekst nije pronaden.",
...
PasteErrorCut	: "Sigurnosne postavke Vašeg pretraživaca ne dozvoljavaju operacije automatskog izrezivanja. Molimo koristite kraticu na tipkovnici (Ctrl+X).",
PasteErrorCopy	: "Sigurnosne postavke Vašeg pretraživaca ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tipkovnici (Ctrl+C).",
...
DlgPasteSec		: "Zbog sigurnosnih postavki Vašeg pretraživaca, editor nema direktan pristup Vašem meduspremniku. Potrebno je ponovno zalijepiti tekst u ovaj prozor.",
...
DlgSpellOneChange		: "Provjera završena: Jedna rijec promjenjena",
DlgSpellManyChanges		: "Provjera završena: Promijenjeno %1 rijeci",
...
DlgTemplatesSelMsg	: "Molimo odaberite predložak koji želite otvoriti<br>(stvarni sadržaj ce biti izgubljen):",
DlgTemplatesLoading	: "Ucitavam listu predložaka. Molimo pricekajte...",
DlgTemplatesNoTpl	: "(Nema definiranih predložaka)",
DlgTemplatesReplace	: "Zamijeni trenutne sadržaje",

// About Dialog
DlgAboutAboutTab	: "O FCKEditoru",
DlgAboutBrowserInfoTab	: "Podaci o pretraživacu",
