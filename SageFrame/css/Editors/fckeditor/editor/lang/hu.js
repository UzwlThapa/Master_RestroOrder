...
PasteWord			: "Beillesztés Word-bol",
Print				: "Nyomtatás",
...
Find				: "Keresés",
Replace				: "Csere",
SpellCheck			: "Helyesírás-ellenorzés",
UniversalKeyboard	: "Univerzális billentyuzet",
PageBreakLbl		: "Oldaltörés",
PageBreak			: "Oldaltörés beillesztése",

Form			: "Urlap",
Checkbox		: "Jelölonégyzet",
RadioButton		: "Választógomb",
TextField		: "Szövegmezo",
Textarea		: "Szövegterület",
HiddenField		: "Rejtettmezo",
Button			: "Gomb",
SelectionField	: "Legördülo lista",
ImageButton		: "Képgomb",
...
VerticalSplitCell	: "Cellák szétválasztása függolegesen",
...
CheckboxProp		: "Jelölonégyzet tulajdonságai",
HiddenFieldProp		: "Rejtett mezo tulajdonságai",
RadioButtonProp		: "Választógomb tulajdonságai",
ImageButtonProp		: "Képgomb tulajdonságai",
TextFieldProp		: "Szövegmezo tulajdonságai",
SelectionFieldProp	: "Legördülo lista tulajdonságai",
TextareaProp		: "Szövegterület tulajdonságai",
FormProp			: "Urlap tulajdonságai",
...
Done				: "Kész",
PasteWordConfirm	: "A beilleszteni kívánt szöveg Word-bol van másolva. El kívánja távolítani a formázást a beillesztés elott?",
...
NoActiveX			: "A böngészo biztonsági beállításai korlátozzák a szerkeszto lehetoségeit. Engedélyezni kell ezt az opciót: \"Run ActiveX controls and plug-ins\". Ettol függetlenül elofordulhatnak hibaüzenetek ill. bizonyos funkciók hiányozhatnak.",
BrowseServerBlocked : "Nem lehet megnyitni a fájlböngészot. Bizonyosodjon meg róla, hogy a felbukkanó ablakok engedélyezve vannak.",
...
DlgGenAccessKey		: "Billentyukombináció",
DlgGenName			: "Név",
...
DlgLnkTargetParent	: "Szülo ablakban (_parent)",
...
DlgLnkPopWinFeat	: "Felugró ablak jellemzoi",
DlgLnkPopResize		: "Méretezheto",
DlgLnkPopLocation	: "Címsor",
DlgLnkPopMenu		: "Menü sor",
DlgLnkPopScroll		: "Gördítosáv",
DlgLnkPopStatus		: "Állapotsor",
DlgLnkPopToolbar	: "Eszköztár",
DlgLnkPopFullScrn	: "Teljes képernyo (csak IE)",
DlgLnkPopDependent	: "Szülohöz kapcsolt (csak Netscape)",
DlgLnkPopWidth		: "Szélesség",
DlgLnkPopHeight		: "Magasság",
DlgLnkPopLeft		: "Bal pozíció",
DlgLnkPopTop		: "Felso pozíció",
...
DlgTableCellPad		: "Cella belso margó",
...
DlgReplaceCaseChk		: "kis- és nagybetu megkülönböztetése",
DlgReplaceReplaceBtn	: "Csere",
DlgReplaceReplAllBtn	: "Az összes cseréje",
DlgReplaceWordChk		: "csak ha ez a teljes szó",

// Paste Operations / Dialog
PasteErrorCut	: "A böngészo biztonsági beállításai nem engedélyezik a szerkesztonek, hogy végrehajtsa a kivágás muveletet. Használja az alábbi billentyukombinációt (Ctrl+X).",
PasteErrorCopy	: "A böngészo biztonsági beállításai nem engedélyezik a szerkesztonek, hogy végrehajtsa a másolás muveletet. Használja az alábbi billentyukombinációt (Ctrl+X).",

PasteAsText		: "Beillesztés formázatlan szövegként",
PasteFromWord	: "Beillesztés Word-bol",

DlgPasteMsg2	: "Másolja be az alábbi mezobe a <STRONG>Ctrl+V</STRONG> billentyuk lenyomásával, majd nyomjon <STRONG>Rendben</STRONG>-t.",
DlgPasteSec		: "A böngészo biztonsági beállításai miatt a szerkeszto nem képes hozzáférni a vágólap adataihoz. Illeszd be újra ebben az ablakban.",
DlgPasteIgnoreFont		: "Betu formázások megszüntetése",
...
DlgSpellProgress		: "Helyesírás-ellenorzés folyamatban...",
DlgSpellNoMispell		: "Helyesírás-ellenorzés kész: Nem találtam hibát",
DlgSpellNoChanges		: "Helyesírás-ellenorzés kész: Nincs változtatott szó",
DlgSpellOneChange		: "Helyesírás-ellenorzés kész: Egy szó cserélve",
DlgSpellManyChanges		: "Helyesírás-ellenorzés kész: %1 szó cserélve",

IeSpellDownload			: "A helyesírás-ellenorzo nincs telepítve. Szeretné letölteni most?",
...
// Form Dialog
DlgFormName		: "Név",
DlgFormAction	: "Adatfeldolgozást végzo hivatkozás",
...
DlgSelectOpAvail	: "Elérheto opciók",
...
DlgDocBgNoScroll	: "Nem gördítheto háttér",
DlgDocCText			: "Szöveg",
DlgDocCLink			: "Cím",
...
DlgDocMaRight		: "Jobb",
DlgDocMaBottom		: "Alsó",
DlgDocMeIndex		: "Dokumentum keresoszavak (vesszovel elválasztva)",
DlgDocMeDescr		: "Dokumentum leírás",
DlgDocMeAuthor		: "Szerzo",
DlgDocMeCopy		: "Szerzoi jog",
DlgDocPreview		: "Elonézet",

// Templates Dialog
Templates			: "Sablonok",
DlgTemplatesTitle	: "Elérheto sablonok",
DlgTemplatesSelMsg	: "Válassza ki melyik sablon nyíljon meg a szerkesztoben<br>(a jelenlegi tartalom elveszik):",
...
DlgAboutBrowserInfoTab	: "Böngészo információ",
