...
// Alerts and Messages
ProcessingXHTML		: "????????? XHTML. Ma?o ????????...",
Done				: "???????",
PasteWordConfirm	: "????? ???? ?????? ?? ???????? ??????? ?? ?? Worda. ?? ?? ?????? ?? ???? ??????? ?? ??????? ??? ????????",
NotCompatiblePaste	: "??? ??????? ?? ???????? ???? ?? ???????? ???????? ?? ??????? 5.5. ?? ?? ?????? ?? ??????? ????? ??? ????????",
UnknownToolbarItem	: "????????? ?????? toolbara \"%1\"",
UnknownCommand		: "????????? ??????? \"%1\"",
NotImplemented		: "??????? ???? ??????????????",
UnknownToolbarSet	: "Toolbar \"%1\" ?? ???????",
...
DlgGenTitle			: "Advisory ??????",
DlgGenContType		: "Advisory ????? ????????",
