    ...
    public partial class Sagin_Default : PageBase, SageFrameRoute
    {
        ...
        private void SagePageLoadPart()
        {
            if (!IsPostBack)
            {
                ...
                string sageNavigateAdminUrl = string.Empty;
                SageFrameConfig sfConfig = new SageFrameConfig();
                ...
                if (!IsParent)
                {
                    ...
                    sageNavigateAdminUrl = string.Format("{0}/portal/{1}/Admin/Admin" + Extension, GetParentURL, GetPortalSEOName);
                }
                else
                {
                    ...
                    sageNavigateAdminUrl = GetParentURL + "/Admin/Admin" + Extension;
                }
                hypHome.NavigateUrl = sageNavigateAdminUrl;//GetHostURL + "/Admin/Admin" + Extension;
