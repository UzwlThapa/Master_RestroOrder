...
namespace SageFrame
{
    ...
    partial class Global : Globals
    {
        ...
        private static void RegisterRoutes(RouteCollection routes)
        {
            ...
            //routes("{*alljs}", new { alljs = @".*\.(js|asmx|jpg|png|jpeg|css)(/.*)?" });
            //routes.("install", new { installwizard = "Install/InstallWizard.aspx" });
            ...
            routes.Add("sfRs4", new System.Web.Routing.Route("admin/admin/Setting/{PagePath}" + ext + "/{*Param}", new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            //Inventory
            routes.Add("sfIn1", new System.Web.Routing.Route("Admin/Inventory/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            ...
            routes.Add("sfRp3", new System.Web.Routing.Route("Admin/Admin/Report/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfRp4", new System.Web.Routing.Route("admin/admin/Report/{PagePath}" + ext + "/{*Param}", new SageFrameRouteHandler("~/Sagin/Default.aspx")));

            //CBMS
            routes.Add("sfcbms1", new System.Web.Routing.Route("Admin/CBMS/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfcbms2", new System.Web.Routing.Route("admin/CBMS/{PagePath}" + ext + "/{*Param}", new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfcbms3", new System.Web.Routing.Route("Admin/Admin/CBMS/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfcbms4", new System.Web.Routing.Route("admin/admin/CBMS/{PagePath}" + ext + "/{*Param}", new SageFrameRouteHandler("~/Sagin/Default.aspx")));

            //Laundry
            routes.Add("sfLaun1", new System.Web.Routing.Route("Admin/Laundry/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfLaun2", new System.Web.Routing.Route("admin/Laundry/{PagePath}" + ext + "/{*Param}", new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfLaun3", new System.Web.Routing.Route("Admin/Admin/Laundry/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
            routes.Add("sfLaun4", new System.Web.Routing.Route("admin/admin/Laundry/{PagePath}" + ext + "/{*Param}", new SageFrameRouteHandler("~/Sagin/Default.aspx")));

            //HouseKeeping
            routes.Add("sfHk1", new System.Web.Routing.Route("Admin/House-Keeping/{PagePath}" + ext, new SageFrameRouteHandler("~/Sagin/Default.aspx")));
