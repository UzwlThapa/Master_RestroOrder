...
<div class="liscening">
    ...
    <div class="liscening-detail" >
        <h2>Your software license has <asp:Label ID="lblDaysLeft" runat="server"></asp:Label>  days left</h2>
     ...
     <div id="divLicenseExpire" runat="server" style="width:60%;margin:auto;">
	<div class="liscening-detail"  >
		<h2>Restro Order Subscription has been expired!!!</h2>
	...
	<div class="licening-btn" style="display:flex;text-align:center;">
        <asp:TextBox ID="txtLicenseKey" runat="server" class="sfInputbox" placeholder="XXXX-XXXX-XXXX-XXXX" style="width:400px;margin-right:10px;height:auto;"></asp:TextBox>        
        <asp:Button ID="btnSaveLincense" runat="server" Text="Validate" OnClick="btnSaveLincense_Click" CssClass="restro-btn" />
        <br /><asp:Label ID="lblKey" runat="server" style="color:#ff0000;"></asp:Label>
	</div>
        </div>
	</div>
	</div>
