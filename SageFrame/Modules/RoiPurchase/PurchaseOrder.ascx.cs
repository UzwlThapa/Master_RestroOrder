...
public partial class Modules_RoiPurchase_PurchaseOrder : System.Web.UI.UserControl
{
    ...
    public void PurchaseMainPrint()
    {
        ...
        filepaths = "/Modules/RoiPurchase/Reports/PurchaseOrder_" + DateTime.Now.ToString("yyyyMMddhhss") + "_" + masterid.ToString() + ".pdf";
    ...
    public void BothReportView()
    {
        ...
        try
        {
            ReportDataSet.USP_PO_PurchaseReportDataTable dta = new ReportDataSet.USP_PO_PurchaseReportDataTable();
            ReportDataSetTableAdapters.USP_PO_PurchaseReportTableAdapter tad = new ReportDataSetTableAdapters.USP_PO_PurchaseReportTableAdapter();
