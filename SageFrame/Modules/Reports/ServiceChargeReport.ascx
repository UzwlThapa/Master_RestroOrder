<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ServiceChargeReport.ascx.cs" Inherits="Modules_Reports_ServiceChargeReport" %>
...
<style type="text/css">
    ...
    #DailyReport .sfGridwrapper tr td.a {
        width: 52px;
    }

    #DailyReport .sfGridwrapper tr td.b {
        width: 240px;
    }
...
<div id="tabs">
    <ul>
        <li><a href="#div1">Service Charge Report</a></li>
    </ul>
    <div id="div1">
