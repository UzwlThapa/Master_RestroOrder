    ...
    <div id='BookingDetail-section' class='left-sec'>
        <div id='BookingRoom'>
            ...
            <tbody>
                ...
                <tr class="AdvancePay">
                    <td>Advance Pay: <label class="PaymentMode"></label><input type="text" onkeypress="return IntegerAndDecimal(event,this);" class="sfInputbox" id="BookAdvancePay" value="0" style="width:150px;"/></td>
