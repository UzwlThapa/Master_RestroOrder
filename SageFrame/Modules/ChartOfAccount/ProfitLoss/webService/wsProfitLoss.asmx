<%@ WebService Language="C#" Class="wsProfitLoss" %>
...
public class wsProfitLoss : System.Web.Services.WebService
{
    ...
    public  string getAllFinancialAcForGrid(string startdate, string enddate)
    {
        ...
        List<AccountInfo> finac= con.getProfitLoss(startdate, enddate);
        return JsonConvert.SerializeObject(finac);
    }
