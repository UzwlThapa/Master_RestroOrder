...
public class CakeOrderWebService : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public string testWebMethod(Object obj)
    {
        return "returned";
    }

    [WebMethod]
    public string SaveCakeOrderIntoDataBase(CakeOrderMaster cakeOrderMasterInfo, List<OrderExtraItems> orderExtraItems, bool cakeorder)
    {
        try
        {
            ...
            cakeOrderMasterInfo.BillNo = "RO" + cakeOrderMasterInfo.Date.ToString().Replace("/", "").Replace("PM", "").Replace("AM", "").Replace(":", "").Replace(" ", "");
            ...
            lst = cocobj.GetOrderDetailsByMaster(cakeOrderMasterInfo.OrderMasterID);
            ...
            cocobj.SaveExtraOrderedItem(addedExtra, removedExtra);
