...
public partial class FrontPage : BaseUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        IncludeCss("FrontPagecss", "/Modules/FontPageHeader/css/animate.css");
		IncludeCss("FrontPagecss", "/Modules/FontPageHeader/css/FrontPage.css");
		IncludeCss("FrontPagecss", "/Modules/FontPageHeader/css/colorbox.css");
		IncludeJs("FrontPagejs", "/Modules/FontPageHeader/js/FrontPage.js");
		IncludeJs("FrontPagejs", "/Modules/FontPageHeader/js/jquery.colorbox.js");
