...
public partial class Modules_ROMenu_ROMenu : BaseAdministrationUserControl
{
    ...
    public void Initialize()
    {
        ...
        IncludeCss("ROMenu", "/Modules/ROMenu/css/module.css");
        IncludeJs("ROMenu", "/Modules/ROMenu/Js/ROMenu.js");
        ...
        foreach (MenuManagerInfo objMenuInfo in objMenuInfoList)
        {
            ...
            if (objMenuInfo.MenuLevel == "0")
            {
                ...
                else
                {
                    if (objMenuInfo.ChildCount > 0)
                    {
                        html.Append("<ul class='mCustomScrollbar'>");
    ...
    public void BuildSideMenu(List<MenuInfo> objMenuInfoList, SageMenuSettingInfo objMenuSetting)
    {
        ...
        {
            html.Append("<div class='ROBlocks'><div class='ROblockpart'><ul class='sfSidemenu'>");
    ...
    {
        string html = "<div id='" + ContainerClientID + "' class='ROBlocks menu clearfix'>";
        switch (MenuMode)
        {
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                html += "<div class='ROBlocksec'><ul class='sf-menu sfCssmenu ROblockpart'>";
                break;
        }
        return html;
    }
    ...
    private string BuildMenuItem(int displayMode, MenuManagerInfo objMenuInfo, string pageLink, string caption)
    {
        ...
        bool isParent = objMenuInfo.ChildCount > 0 ? true : false;
        switch (displayMode)
        {
            case 0://image only
                if (caption == "1")
                {
                    html.Append("<a class='" + (isParent ? "" : "iframe ") + title.Replace(" ", "-") + "' href='");
                    html.Append(isParent ? "#" : pageLink);
    ...
    private string BuildSideMenuItem(int displayMode, MenuInfo objMenuInfo, string pageLink, string caption)
    {
        ...
        switch (displayMode)
        {
            case 0://image only
                if (caption == "1")
                {
                    html.Append("<a class='iframe "+title.Replace(" ", "-")+"'");
