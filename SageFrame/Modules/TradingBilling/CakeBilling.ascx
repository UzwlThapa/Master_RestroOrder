<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CakeBilling.ascx.cs" Inherits="Modules_CakeBilling_CakeBilling" %>
<style>
    div#CusOrder img {
        position: absolute;
        right: 10px;
...
<div class="RO_wrapper">
    <div class="report-filter">
             <span>Search :</span> <input type="text" class="sfInputbox" id="txtSearch" />

    </div>
  <div id="tabs" class="hometab" style="display: none;padding:10px;">
        <ul>
            <li><a href="#OccupiedTablesdiv">Wholesale Orders</a></li>
            <li><a href="#TakeAwayOrdersdiv">Retail Orders</a></li>
...
<div class="shiftLRT" style="border-right:1px solid #dcdcdc;">
    <div id="tableToShift">
        <table style="margin:0;">
            ...
            <tr>
                <td>Seat No : <select id="shiftingTableSeatNo" class="sfInputbox"></select></td>
            </tr>
        </table>
    </div>
    </div>
    ...
    <div id="shiftToTable">
        <table style="margin:0;">
            ...
            <tr>
                <td>Seat No : <select id="shiftToTableSeatNo" class="sfInputbox"></select></td>
            </tr>
            <tr>
                <td><label class="sfBtn restro-btn" id="confirmShift">Shift</label></td>
            </tr>
    ...
    <div id='BookingDetail-section' class='left-sec'>
        <div id='BookingRoom'>
            ...
            <tbody>
                ...
                <tr>
                    <td> Rate : <input type='text' id='txtRate' class='sfInputbox' value='' style="width:150px;"/></td>
                ...
                <tr class="AdvancePay">
                    <td>Advance Pay: <input type="text" onkeypress="return IntegerAndDecimal(event,this);" class="sfInputbox" id="BookAdvancePay" value="0" style="width:150px;" disabled/></td>
                ...
                <tr>
                    <td>Remarks (*): <label class="PaymentMode"></label>
