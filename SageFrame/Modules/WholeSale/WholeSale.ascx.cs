...
public partial class Modules_WholeSale_WholeSale : BaseUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        IncludeJs("", "/Modules/TradingBilling/js/CakeBillBind.js");
        if (ordermenulisttype == "true")
        {
            IncludeCss("Order", "/Modules/Order/css/orderlistview.css");
        }
        IncludeJs("", "/Modules/WholeSale/js/WholeSale.js");
