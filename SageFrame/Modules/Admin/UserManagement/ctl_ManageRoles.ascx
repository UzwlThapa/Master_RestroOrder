    ...
    <div class="sfFormwrapper">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td width="15%">
                    <asp:Label ID="lblCreditLimit" runat="server" CssClass="sfFormlabel" Text="Credit Limit"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCreditLimit" runat="server" CssClass="sfInputbox" ></asp:TextBox>
                    <asp:RegularExpressionValidator ID='vldNumber' ControlToValidate='txtCreditLimit' Display='Dynamic' ErrorMessage='Not a number' ValidationExpression='(^([0-9]*|\d*\d{1}?\d*)$)' runat='server'>
...
<asp:Panel ID="pnlRoles" runat="server">
    ...
    <div class="sfGridwrapper">
        <asp:GridView ID="gdvRoles" runat="server" AutoGenerateColumns="False" GridLines="None"
            OnRowDeleting="gdvRoles_RowDeleting" DataKeyNames="Role,RoleID" Width="95%"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-CssClass="sfDelete">
                    <ItemTemplate>
                        ...
                        <span class='icon-edit creadit-limit' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
