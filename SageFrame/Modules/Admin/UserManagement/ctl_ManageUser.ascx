...
<asp:Panel ID="pnlManageUser" runat="server" meta:resourcekey="pnlManageUserResource1">
    ...
    <ajax:TabContainer ID="TabContainerManageUser" runat="server" ActiveTabIndex="0"
                        ...
                        <tr runat="server">
                            ...
                            <td runat="server">
                                <div class="sfButtonwrapper">
                                    <asp:LinkButton Text="Update" CssClass="icon-update sfBtn restro-btn" ID="imgUserInfoSave" runat="server"
                            ...
                            <td>
                                <div class="sfButtonwrapper">
                                    <asp:LinkButton ID="imgManageRoleSave" runat="server" OnClick="imgManageRoleSave_Click"
                                        CssClass="icon-update sfBtn restro-btn" Text="Update" meta:resourcekey="imgManageRoleSaveResource1" />
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="sfFormwrapper">
                    <table id="tblChangePasswordSettings" runat="server" width="100%" cellpadding="0"
                        ...
                        <tr runat="server">
                            ...
                            <td runat="server">
                                <div class="sfButtonwrapper">
                                    <asp:LinkButton ID="btnManagePasswordSave" runat="server" CssClass="icon-save sfBtn restro-btn" OnClick="btnManagePasswordSave_Click" Text="Save" ValidationGroup="vgManagePassword" />
                                </div>
        ...
        <ajax:TabPanel ID="tabUserPin" runat="server" meta:resourcekey="tabUserPinResource1">
            <HeaderTemplate>
                <asp:Label ID="lblPIN" runat="server" Text="Change PIN" meta:resourcekey="lblPINResource1"></asp:Label>
            </HeaderTemplate>
            <ContentTemplate>
                <p class="sfNote">
                    <asp:Label ID="Label1" runat="server" Text="To change the PIN for this user, enter the new PIN Code to confirm it."
                        meta:resourcekey="lblCPINResource1"></asp:Label>
                </p>
                <div class="sfFormwrapper">
                    <table id="tblChangePINCode" runat="server" width="100%" cellpadding="0"
                        cellspacing="0" border="0">
                        <tr runat="server">
                            <td width="20%" runat="server">
                                <asp:Label ID="lblNewPIN" runat="server" CssClass="sfFormlabel" Text="New PIN"></asp:Label>
                            </td>
                            <td runat="server">
                                <div class="sfPassword">
                                    <asp:TextBox ID="txtNewPIN" runat="server" MaxLength="20" CssClass="sfInputbox"
                                        ValidationGroup="vgManagePIN" ></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtNewPIN"
                                        ErrorMessage="PIN is required." CssClass="sfRequired" ValidationGroup="vgManagePIN"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator7" ControlToValidate="txtNewPIN" runat="server" ValidationGroup="vgManagePIN" ErrorMessage="Only 4 digit Numbers allowed" ValidationExpression="^[0-9]{4}$"></asp:RegularExpressionValidator>
                                </div>
                            </td>
                        </tr>
                        <tr runat="server">
                            ...
                            <td runat="server">
                                <div class="sfButtonwrapper">
                                    <asp:LinkButton ID="btnManagePIN" runat="server" CssClass="icon-save sfBtn restro-btn" OnClick="btnManagePINSave_Click" Text="Save" ValidationGroup="vgManagePIN" />
                                </div>
                                <div class="sfValidationsummary">
                                    <label id="lblChangepinval" class="sfError">
                                    </label>
                                </div>
                            </td>
                            <td runat="server"></td>
                    ...
                    <div class="sfViewprofile">
                        <table id="tblEditProfile" width="100%" cellpadding="0" cellspacing="0" runat="server">
                            ...
                            <tr runat="server">
                                ...
                                <td runat="server">
                                    <div class="sfButtonwrapper">
                                        <label class="icon-save sfBtn restro-btn sfLocale">
                                            Save
                                        <asp:Button ID="btnSave" runat="server" CssClass="icon-save sfBtn restro-btn" OnClick="btnSave_Click"
                        ...
                        <div class="sfViewprofile">
                            <table id="tblViewProfile" cellpadding="0" cellspacing="0" width="100%" runat="server">
                                ...
                                <tr runat="server">
                                    ...
                                    <td runat="server">
                                        <div class="sfButtonwrapper">
                                            <asp:LinkButton ID="btnEdit" runat="server" CssClass="icon-edit sfBtn restro-btn" OnClick="btnEdit_Click"
                                                Text="Edit" />
                                        </div>
                                    </td>
                                </tr>
    ...
    <div class="sfButtonwrapper">
        <asp:LinkButton ID="imgBack" runat="server" Text="Cancel" CssClass="icon-close sfBtn restro-btn"
...
<asp:Panel ID="pnlUser" runat="server" meta:resourcekey="pnlUserResource1">
        ...
        <div class="sfCol_50">
            <table>
                ...
                <tr>
                    ...
                    <td class="sfMiddle">
                        <asp:ListBox ID="lstAvailableRoles" CssClass="sfInputbox sfListmenu" runat="server" SelectionMode="Multiple"
    ...
    <div class="sfButtonwrapper">
        <asp:LinkButton ID="imbCreateUser" Text="Create User" CssClass="icon-add-user sfBtn restro-btn"
        ...
        <asp:LinkButton ID="imbBackinfo" runat="server" OnClick="imgBack_Click" ToolTip="Back"
            Text="Cancel" CssClass="icon-close sfBtn restro-btn" meta:resourcekey="imbBackinfoResource1" />
    </div>
</asp:Panel>
<asp:Panel ID="pnlUserList" runat="server" meta:resourcekey="pnlUserListResource1">
    <div class="sfButtonwrapper sfPadding">
        <asp:LinkButton ID="imgAddUser" runat="server" OnClick="imgAddUser_Click" Text="Add User"
            CssClass="icon-add-user sfBtn restro-btn restro-btn" ToolTip="Add User" meta:resourcekey="imgAddUserResource1" />
        <asp:LinkButton ID="imgBtnDeleteSelected" Text="Delete Selected Users" CssClass="icon-delete-user sfBtn restro-btn restro-btn"
        ...
        <asp:LinkButton Text="Update changes" CssClass="icon-update sfBtn restro-btn restro-btn" ID="imgBtnSaveChanges"
        ...
        <asp:LinkButton ID="imgBtnSettings" CssClass="icon-user-setting sfBtn restro-btn restro-btn" Text="User Settings"
            runat="server" ToolTip="UserSettings" OnClick="imgBtnSettings_Click" meta:resourcekey="imgBtnSettingsResource1" />

        <asp:LinkButton ID="imgBtnExportUser" CssClass="icon-excel sfBtn restro-btn restro-btn" Text="User Export"
            runat="server" ToolTip="UserExport" OnClick="imgBtnExportUser_Click" />
        <asp:LinkButton ID="imgBtnImportUser" CssClass="icon-excel sfBtn restro-btn restro-btn" Text="User Import"
            runat="server" ToolTip="UserImport" OnClick="imgBtnImportUser_Click" />
        <asp:LinkButton ID="imgBtnSuspendedIP" CssClass="icon-ip-setting sfBtn restro-btn restro-btn" Text="Suspended User"
            runat="server" ToolTip="SuspendedUser" OnClick="imgBtnSuspendedIP_Click" />


    </div>
    <div class="sfFormwrapper sfUsersearch sfTableOption">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="sfTableOption1" style="display:block;margin-bottom:0px">
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList ID="ddlSearchRole" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSearchRole_SelectedIndexChanged"
                        CssClass="sfListmenu sfInputbox" meta:resourcekey="ddlSearchRoleResource1">
                    </asp:DropDownList>
                ...
                <td>
                    <asp:TextBox ID="txtFrom" runat="server" CssClass="sfInputbox sfInputdate" meta:resourcekey="txtFromResource1" style="width:100px;"></asp:TextBox>
                </td>
                <td>
                    <label class="sfFormlabel">
                        To</label>
                ...
                <td>
                    <asp:TextBox ID="txtTo" runat="server" CssClass="sfInputbox sfInputdate" meta:resourcekey="txtToResource1" style="width:100px;"></asp:TextBox>
                </td>
                <td>
                    <asp:LinkButton ID="imgSearch" Text="Search" CssClass="icon-search sfBtn restro-btn" runat="server"
            ...
            <tr>
                <td>
                 <asp:Label ID="lblShowMode" runat="server" Text="Filter Mode" CssClass="sfFormlabel"
                        meta:resourcekey="lblShowModeResource1" style="float:left;margin-top: 5px;
    margin-right: 10px;"></asp:Label>
                ...
                <td style="float:right;">
                    <asp:Label ID="lblSRow" runat="server" Text="Show rows" CssClass="sfFormlabel" meta:resourcekey="lblSRowResource1" style="float:left;margin-top: 5px;
    margin-right: 10px;"></asp:Label>
                    <asp:DropDownList ID="ddlRecordsPerPage" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlRecordsPerPage_SelectedIndexChanged"
                        CssClass="sfInputbox sfListmenu sfAuto" meta:resourcekey="ddlRecordsPerPageResource1" style="width:80px;">
            ...
            <Columns>
                ...
                <asp:TemplateField meta:resourcekey="TemplateFieldResource6">
                 ...
                 <asp:TemplateField meta:resourcekey="TemplateFieldResource7">
                    ...
                    <HeaderTemplate>
                        <asp:Label ID="lblPIN" runat="server" meta:resourcekey="lblPINResource1" Text="PIN Code" style=""></asp:Label>
                    </HeaderTemplate>
                </asp:TemplateField>
                <asp:TemplateField meta:resourcekey="TemplateFieldResource7">
                    <ItemTemplate>
...
<asp:Panel ID="pnlSettings" runat="server" meta:resourcekey="pnlSettingsResource1">
    ...
    <div class="sfButtonwrapper">
        <label class="sfLocale icon-save sfBtn restro-btn">
            Save
        ...
        <asp:LinkButton ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click"
            ToolTip="Cancel" meta:resourcekey="btnCancelResource1" CssClass="icon-close sfBtn restro-btn" />
    </div>
</asp:Panel>
<asp:Panel ID="pnlUserImport" runat="server">
    <div class="sfFormwrapper">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" style="display:block;">
            ...
            <tr>
                <td>
                    <label id="lblImport" class="sfLocale icon-save sfBtn restro-btn">
                        Import
            <asp:Button runat="server" ID="btnUserImport" OnClick="btnUserImport_Click" ValidationGroup="ImportUserValidation" />
                    </label>
                    <label id="lblCancel" class="sfLocale icon-close sfBtn restro-btn">
                        Cancel
            <asp:Button runat="server" ID="btnImportCancel" OnClick="btnImportCancel_Click" />
                    </label>
                    <label id="lblDuplicateUser" class="sfLocale icon-excel sfBtn restro-btn" runat="server">
...
<asp:Panel ID="pnlSuspendedIP" runat="server" class="sfFormwrapper">
    ...
    <div class="sfButtonwrapper">
        <div id="divSave" runat="server" style="float: left;">
            <label id="lblSaveChanges" class="sfLocale icon-save sfBtn restro-btn">
                Save changes
        ...
        <label id="lblCancelSuspendedUser" class="sfLocale icon-close sfBtn restro-btn">
            Cancel
