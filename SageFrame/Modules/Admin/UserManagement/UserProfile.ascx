...
<div class="sfEditprofile">
    <div id="sfUserProfile" runat="server" class="sfFormwrapper sfUserprofile clearfix">
        ...
        <div id="TabProfile" class="order-tab">
            <ul>
            ...
            <div id="ProfileSetting" class="sfFormwrapper clearfix">
                ...
                <div class="sfProfilewrapper">
                    ...
                    <div class="sfButtonwrapper clearfix sfTopmargin20" id="divSaveProfile" runat="server">
                        <label class="sfLocale sfBtn icon-save restro-btn">
                            Save
                        ...
                        <asp:LinkButton ID="lnkCancel" CssClass="sfBtn icon-close restro-btn" runat="server" Text="Cancel" OnClick="lnkCancel_Click"
                        ...
                        <td id="Td3" runat="server">
                            <div class="sfPassword">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNewPassword"
                                    ...
                                    meta:resourcekey="RequiredFieldValidator1Resource1" display="Dynamic" ></asp:RequiredFieldValidator>
                            </div>
                        </td>
                    </tr>
                    <tr id="Tr2" runat="server">
                        <td id="Td4" runat="server" style="width:150px;">
                        ...
                        <td id="Td6" runat="server">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtRetypeNewPassword"
                                ...
                                meta:resourcekey="RequiredFieldValidator5Resource1" display="Dynamic"  ></asp:RequiredFieldValidator>
            ...
            <div id="Changepin">
                <table id="tblChangePINCode" runat="server" width="100%" cellpadding="0"
                    cellspacing="0" border="0" style="display:block;">
                    <tr runat="server">
                        ...
                        <td runat="server">
                            <div class="sfPassword">
                                <asp:TextBox ID="txtNewPIN" runat="server" MaxLength="20" CssClass="sfInputbox" TextMode="Password"
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtNewPIN"
                                    ErrorMessage="PIN is required." CssClass="sfRequired" ValidationGroup="vgManagePIN" display="dynamic"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" ControlToValidate="txtNewPIN" runat="server" ValidationGroup="vgManagePIN" ErrorMessage="Only 4 digit Numbers allowed" ValidationExpression="^[0-9]{4}$" display="dynamic"></asp:RegularExpressionValidator>
                            </div>
                        </td>
                    </tr>
                    <tr runat="server">
     ...
     <div class="sfProfileimage" runat="server" id="imgProfileView">
        ...
        <div class="sfViewprofile sfPadding clearfix">
            ...
            <div class="sfButtonwrapper" id="divEditprofile" runat="server">
                <label class="sfLocale sfBtn icon-edit restro-btn">
                    Edit
