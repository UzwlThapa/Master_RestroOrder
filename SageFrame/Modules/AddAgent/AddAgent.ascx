<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddAgent.ascx.cs" Inherits="Modules_AddAgent_AddAgent" %>
<style>
        ...
        <div class="main">
            <table style="display:block;">
                ...
                <tr class="custo">
                    ...
                    <td>
                        <input type="text" id="txtCommission" class="sfInputbox " name="Commission" onkeypress='return IntegerAndDecimal(event,this);' placeholder="percentage" />
                    </td>
                </tr>
                <%--<tr class="custo">
