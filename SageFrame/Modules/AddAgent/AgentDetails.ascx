<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AgentDetails.ascx.cs" Inherits="Modules_AddAgent_AgentDetails" %>
        ...
        <div class="main" style="display: none;margin:15px;margin-bottom:0px;">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtCommission" class="sfInputbox " name="Discount" placeholder="percentage" />
                    </td>
