    ...
    $.companyProfcreate = function (p) {
        ...
        var companyProf = {
            config: {
                ...
                data: {},
                dataType: 'json',
                baseURL: p.ModulePath + "AgentWebService.asmx/",
                method: "",
                url: "",
                ajaxCallMode: 0,
                MembershipID: 0,
            ...
            DeleteItem: function (id) {
                ...
                companyProf.config.method = "deleteAgent";
                companyProf.config.url = companyProf.config.baseURL + companyProf.config.method;
            ...
            getmember: function () {
                var customer = 1;
                companyProf.config.method = "getAgents";
                companyProf.config.url = companyProf.config.baseURL + companyProf.config.method;
                companyProf.config.data = JSON2.stringify({ agent: 1 });
            ...
            SaveMembership: function () {
               ...
               // MemberInfo.CardNumber = $('#txtCardNumber').val();
                ...
                MemberInfo.Commission = $('#txtCommission').val();
                if (MemberInfo.Commission == "") {
                    MemberInfo.Commission = 0;
                }
                MemberInfo.IsAgent = true;
                MemberInfo.IsVat = false;
                MemberInfo.AddedBy = SageFrameUserName;
                companyProf.config.method = "SaveAgent";
                companyProf.config.url = companyProf.config.baseURL + companyProf.config.method;
            ...
            Bindmember: function () {
                ...
                htmls += "<thead>"
                htmls += "<tr>"
                htmls += "<th><input type='checkbox' class='checkbox'  id='select_all' /></th><th style='width:200px'> Name </th><th style='width:200px'> Address </th><th>PAN</th><th> Company </th><th> ContactNo.</th><th style='width:90px'> Commission(%) </th><th class='tdrate' style='width:90px'> RMNG BAL </th><th class='tdrate' style='width:90px'> Total Paid </th>"
                ...
                if (datas.length > 0) {
                    $.each(datas, function (index, value) {
                        ...
                        if (value.Name.toLowerCase().includes(search) || value.TelMobile.toLowerCase().includes(search) || value.Addresss.toLowerCase().includes(search) || search == '') {
                            ...
                            htmls += "<td style='width:90px'>" + value.Commission + " %</td>";
