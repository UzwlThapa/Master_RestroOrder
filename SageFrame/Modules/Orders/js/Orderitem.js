            ...
            ajaxSuccess: function (data) {
                switch (parseInt(OrderItemFunction.config.ajaxCallMode)) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        jAlert('Ordered Saved successfully', 'Information!!', function () { $.alerts.dialogClass = null; });
                        var url = p.HostUrl;
                        window.location.href = url;
                    case 6:
                        var id = OrderItemFunction.config.ID;
            ...
            BindItemByCategoryID: function (result) {
                ...
                $('.itemimg').on('click', function () {
                    ...
                    if (result == 0) {
                        ...
                        jAlert('Item Already Entered Please increase the Quantity', "Alert!!", function () { $.alerts.dialogClass = null; });
                    }
