...
public partial class Modules_ConsumptionReport_ConsumptionReport : BaseUserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        IncludeJs("", "/js/jsPDF.js");
        IncludeJs("ConsumptionReport", "/Modules/ConsumptionReport/js/jsConsumption.js");
