...
public partial class Modules_Admin_ClosingReport3_Monthly_ClosingReport3_Monthly : BaseUserControl
{
    protected void Page_Load(object sender, EventArgs e)
    { 
        Includes();
        IncludeJs("", "/js/jsPDF.js");
        IncludeJs("ClosingReport", "/Modules/ClosingReport3_Monthly/js/jsClosingReport3_Monthly.js");
