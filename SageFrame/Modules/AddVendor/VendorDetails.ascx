<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VendorDetails.ascx.cs" Inherits="Modules_AddVendor_VendorDetails" %>
...
<style>
    ...
    <div>
        ...
        <div>
            ...
            <div id="VenderListing" class="fpwrapper"></div>
        </div>
    </div>
</div>