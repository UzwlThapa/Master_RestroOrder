...
public class UploadHandler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else
        {
            ...
            //{
            //    string[] checkValidityForResume = { "pdf", "vnd.openxmlformats-officedocument.wordprocessingml.document" };
            ...
            else
            {
                if (type == 1)
                {
                    realFilePath = HttpContext.Current.Server.MapPath("~/Modules/ROCategory/images/");
                }
                ...
                while (true)
                {
                    ...
                    if (fileInformation.Exists)
                    {
                        ...
                        fileName = "SliderImage" + DateTime.Now.ToString("yyyyMMddhhss") + i + "." + renamer[1];
                        fileFullPathToFolder = realFilePath + fileName;
                        i++;
                    }
                    else
