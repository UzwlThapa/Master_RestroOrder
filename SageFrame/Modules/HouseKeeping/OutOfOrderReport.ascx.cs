...
public partial class Modules_HouseKeeping_OutOfOrderReport : BaseAdministrationUserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {

        IncludeJs("HouseKeeping", "/Modules/HouseKeeping/js/OutOfOrderReport.js");
