...
function SaveOrderedData() {
    ...
    ordermaster.OrderTypeID = retailorder == true ? 8 : (foodCourtOrder == true ? 3 : (TableId > 0 ? 1 : 2));
    ...
    $.ajax({
        ...
        data: JSON2.stringify({ cakeOrderMasterInfo: ordermaster, orderExtraItems: ExtraItems, wholesaleorder: retailorder }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function GetDataForSalesBill(orderMasterId) {
    $.ajax({
        ...
        data: JSON2.stringify({ orderMasterId: orderMasterId, SalesType: 'retail' }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            ...
            if (orderdetails.length > 0) {
                htmls += ("<div class='left-sec'><h4>Retails Details</h4>");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#btnPrints').unbind('click').on('click', function () {
                ...
                savePrintCount((parseInt($('#hdfPrntCnt').val()) + 1), parseInt($('#hdfSMID').val()), SageFrameUserName, 'retail');
            });
