...
GO
ALTER TABLE [dbo].[RO_LoyaltyMembership] ADD  CONSTRAINT [DF_RO_LoyaltyMembership_DateOfIssue]  DEFAULT (getdate()) FOR [DateOfIssue]
GO
ALTER TABLE [dbo].[RO_LoyaltyMembership] ADD  CONSTRAINT [DF_RO_LoyaltyMembership_RemainingBalance]  DEFAULT ((0)) FOR [RemainingBalance]
GO
ALTER TABLE [dbo].[RO_LoyaltyMembership] ADD  CONSTRAINT [DF_RO_LoyaltyMembership_UptoNowPaid]  DEFAULT ((0)) FOR [UptoNowPaid]
GO
ALTER TABLE [dbo].[RO_LoyaltyMembership] ADD  CONSTRAINT [DF_RO_LoyaltyMembership_IsVat]  DEFAULT ((0)) FOR [IsVat]
GO
