...
EXEC dbo.usp_ac_getProfitLoss '2024-02-22','2024-02-22'

*/
CREATE PROCEDURE [dbo].[usp_ac_getProfitLoss]
    @StartDate DATETIME ,
    @EndDate DATETIME
AS
    BEGIN;
        ...
        --DECLARE @AccEntryTypeBSId INT;
        --SELECT @AccEntryTypeBSId = Id
        --FROM   dbo.Ac_EntryType
        ...
        INSERT #AccountLedger ( PFinancialAcID ,
               ...
               AND      ISNULL (FA.AccEntryType, 0) = @AccEntryTypeId --IN ( @AccEntryTypeId, @AccEntryTypeBSId )
