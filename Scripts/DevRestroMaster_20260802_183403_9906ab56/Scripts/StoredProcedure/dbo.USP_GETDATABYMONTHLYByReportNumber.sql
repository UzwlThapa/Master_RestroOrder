...
GO
--USP_GETDATABYMONTHLYByReportNumber  '2016','10',2
CREATE PROCEDURE [dbo].[USP_GETDATABYMONTHLYByReportNumber] @year VARCHAR(10)
	,@month VARCHAR(10)
	,@ReportNum INT
AS
BEGIN
	...
	-- where Year(om.BillDate)=@year and Month(om.BillDate)=@month
	--END
