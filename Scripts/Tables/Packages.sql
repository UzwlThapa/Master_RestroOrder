...
CREATE TABLE [dbo].[Packages](
	...
	[IsActive] [bit] NULL CONSTRAINT [DF_Packages_IsActive]  DEFAULT ((1)),
	[IsDeleted] [bit] NULL CONSTRAINT [DF_Packages_IsDeleted]  DEFAULT ((0)),
	[IsModified] [bit] NULL CONSTRAINT [DF_Packages_IsModified]  DEFAULT ((0)),
	[AddedOn] [datetime] NULL CONSTRAINT [DF_Packages_AddedOn]  DEFAULT (getdate()),
	[UpdatedOn] [datetime] NULL CONSTRAINT [DF_Packages_UpdatedOn]  DEFAULT (getdate()),
